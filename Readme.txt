...
If you want to use node.js as the web server, you can type following in the command line:

xxxxx@Lenovo:/cygdrive/c/workspace/javascript/AngularJSDemos$ node server.js